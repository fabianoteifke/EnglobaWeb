...
<div class="body1">
  <div class="main">
    ...
    <header>
      <div class="wrapper">
        <nav>
          <ul id="menu">
            ...
            <li><a href="../production/login.php#signup">Cadastrar minha escola</a></li>
      ...
      <div id="slogan"> Nós vamos abrir o mundo<span>do conhecimento online para você!</span> </div>
      <ul class="banners">
    ...
    <section id="content">
      ...
      <div class="box1">
        <div class="wrapper">
          <article class="col1">
            <div class="pad_left1">
              <h2>Bem vindo ao EnglobaWeb</h2>
              <p class="font2">O EnglobaWeb é uma plataforma estudantil, onde a administração escolar, professores e alunos andam juntos.</p>
