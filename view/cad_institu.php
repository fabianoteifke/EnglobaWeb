                    ...
                    <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
                        <div class="menu_section">
                            ...
                            <ul class="nav side-menu">
                                ...
                                <li><a href="escolas.php"><i class="fa fa-calendar"></i> Gerenciar minha escola <span
                        ...
                        <ul class="nav navbar-nav navbar-right">
                            <li class="">
                                ...
                                <ul class="dropdown-menu dropdown-usermenu pull-right">
                                    ...
                                    <li><a href="../controller/deslogar.php"><i class="fa fa-sign-out pull-right"></i>
                                            Log Out</a></li>
                                </ul>
                            </li>
...
?>
                                ...
                                <div class="x_content">
                                    ...
                                    <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left"
                                        method="post" action="cad_institu.php">
                                        <div class="form-group">
                                            <label class="control-label col-md-3 col-sm-3 col-xs-12" for="first-name">Nome
                                                da instituição <span class="required">*</span>
                                            </label>
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                                <input type="text" id="name_inst" name="name_inst" required="required"
                                        ...
                                        <div class="form-group">
                                            <label class="control-label col-md-3 col-sm-3 col-xs-12" for="last-name">Endereço
                                                da instituição <span class="required">*</span>
                                            </label>
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                                <input type="text" id="last-name" name="endereco" required="required"
                                                    class="form-control col-md-7 col-xs-12">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="control-label col-md-3 col-sm-3 col-xs-12">Vai querer um
                                                repositório de documentos?</label>
                                            <div class="col-md-9 col-sm-9 col-xs-12">
                                                <div class="">
                                                    <label>
                                                        <input type="checkbox" class="js-switch" value="1" name="documen"
                                                            checked /> Repositório de documentos
                                                    </label>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="control-label col-md-3 col-sm-3 col-xs-12">Tipo de
                                                instituição</label>
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                                <div id="gender" class="btn-group" data-toggle="buttons">
                                                    <label class="btn btn-default" data-toggle-class="btn-primary"
                                                        data-toggle-passive-class="btn-default">
                                                        <input type="radio" name="curso" value="1"> &nbsp; Cursos e
                                                        turmas &nbsp;
                                                    </label>
                                        ...
                                        <div class="form-group">
                                            <label for="nome" class="control-label col-md-3 col-sm-3 col-xs-12">Seu
                                                nome</label>
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                                <input id="nome" class="form-control col-md-7 col-xs-12" type="text"
                                                    name="nome">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                                <input id="login" class="form-control col-md-7 col-xs-12" type="text"
                                                    name="login">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            <label for="senha2" class="control-label col-md-3 col-sm-3 col-xs-12">Confirmar
                                                senha</label>
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                                <input id="senha2" class="form-control col-md-7 col-xs-12" type="password"
                                                    name="senha2">
                                            </div>
                                        </div>
                                        <div class="form-group">
