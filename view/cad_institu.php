                ...
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    ...
                    <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">
                      ...
                      <div class="form-group">
                                <label class="control-label" for="estado">Selecione o estado *:</label>
                                <select id="estados" class="form-control input-md" required="" name="estado">
                                    <option value=""></option>
                                </select>
                            </div>
                            <div class="form-group">
                                <label class="control-label" for="estado">Selecione a cidade *:</label>
                                <select id="cidades" class="form-control input-md" required="" name="cidade">
                                </select>
                            </div>
                      <div class="form-group">
